...
assert.match(loader, /lunea-ai-spread-preflight-v2\.js\?v=106/, 'preflight cache must be bumped for V6 behavior');
...
assert.match(loader, /lunea-user-spread-learning-v1\.js\?v=109/, 'learning engine cache must load canonical v3 row upgrader');
