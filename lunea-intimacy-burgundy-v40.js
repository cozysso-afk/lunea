...
(() => {
  ...
  const CATEGORY_ICON_SRC = `./assets/intimacy-oracle/intimacy_sector_final.png?v=${encodeURIComponent(SELF_VERSION)}`;
  ...
  function apply() {
    ...
    repairTarotCards();
    return !!(category || document.querySelector('#cards .tarot-card-wrapper'));
  }
