...
/* Loader shim: Structural V4 + Manual Spread + reusable library + last-reading recovery + extended Transit range + iOS sheet scroll fix + all-category manual entry + Horary multi-target guard + A/B Timing Oracle. */
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-transit-range-v1.js?v=101"><\/script>');
    document.write('<script src="./lunea-sheet-scroll-fix-v1.js?v=104"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-transit-range-v1.js?v=101',
    './lunea-sheet-scroll-fix-v1.js?v=104',
