...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-reading-draft-v1.js?v=db7e24fffdde"><\/script>');
    ...
    document.write('<script src="./lunea-transit-range-v1.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-transit-long-run-v1.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-astro-job-queue-v1.js?v=db7e24fffdde"><\/script>');
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=db7e24fffdde"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-intimacy-ai-bridge-v34.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-intimacy-legacy-v35.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-intimacy-readability-v36.js?v=db7e24fffdde"><\/script>');
    ...
    document.write('<script src="./lunea-astro-resume-v23.js?v=db7e24fffdde"><\/script>');
    ...
    document.write('<script src="./lunea-fixed-spread-depth-v30.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-general-order-v30-5.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-reading-boundary-reset-v31.js?v=3102"><\/script>');
    document.write('<script src="./lunea-reading-action-order-v33.js?v=db7e24fffdde"><\/script>');
    document.write('<script src="./lunea-boot-reveal-v29.js?v=db7e24fffdde"><\/script>');
    return;
  }
  ...
  loadSequential([
    ...
    './lunea-reading-draft-v1.js?v=db7e24fffdde',
    ...
    './lunea-transit-range-v1.js?v=db7e24fffdde',
    './lunea-transit-long-run-v1.js?v=db7e24fffdde',
    './lunea-astro-job-queue-v1.js?v=db7e24fffdde',
    ...
    './lunea-thai-tarot-bridge-v32.js?v=db7e24fffdde',
    './lunea-thai-range-v33.js?v=db7e24fffdde',
    './lunea-final-prompt-priority-v1.js?v=db7e24fffdde',
    ...
    './lunea-cardback-restore-v19.js?v=db7e24fffdde',
    './lunea-universal-ai-opal-v20.js?v=db7e24fffdde',
    './lunea-intimacy-v34.js?v=db7e24fffdde',
    './lunea-intimacy-ai-bridge-v34.js?v=db7e24fffdde',
    './lunea-intimacy-legacy-v35.js?v=db7e24fffdde',
    './lunea-intimacy-readability-v36.js?v=db7e24fffdde',
    './lunea-learning-success-gate-v1.js?v=101',
    './lunea-daily-orbit6-v21.js?v=2102',
    './lunea-daily-celestial-v22.js?v=2201',
    './lunea-astro-resume-v23.js?v=db7e24fffdde',
    ...
    './lunea-fixed-spread-depth-v30.js?v=db7e24fffdde',
    './lunea-general-order-v30-5.js?v=db7e24fffdde',
    './lunea-reading-boundary-reset-v31.js?v=3102',
    './lunea-reading-action-order-v33.js?v=db7e24fffdde',
    './lunea-boot-reveal-v29.js?v=db7e24fffdde'
