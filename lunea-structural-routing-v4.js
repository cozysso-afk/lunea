...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=9bbc70e5ca5a"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=9bbc70e5ca5a"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=9bbc70e5ca5a"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=9bbc70e5ca5a"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=2002"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=3401"><\/script>');
    ...
    document.write('<script src="./lunea-reading-action-order-v33.js?v=9bbc70e5ca5a"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-thai-tarot-bridge-v32.js?v=9bbc70e5ca5a',
    './lunea-thai-range-v33.js?v=9bbc70e5ca5a',
    './lunea-final-prompt-priority-v1.js?v=9bbc70e5ca5a',
    ...
    './lunea-cardback-restore-v19.js?v=9bbc70e5ca5a',
    './lunea-universal-ai-opal-v20.js?v=2002',
    './lunea-intimacy-v34.js?v=3401',
    ...
    './lunea-reading-action-order-v33.js?v=9bbc70e5ca5a',
