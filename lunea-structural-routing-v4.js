...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=87b5a4433f25"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=87b5a4433f25"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=87b5a4433f25"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=87b5a4433f25"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=2002"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=87b5a4433f25"><\/script>');
    document.write('<script src="./lunea-intimacy-ai-bridge-v34.js?v=87b5a4433f25"><\/script>');
    document.write('<script src="./lunea-intimacy-legacy-v35.js?v=87b5a4433f25"><\/script>');
    document.write('<script src="./lunea-intimacy-readability-v36.js?v=87b5a4433f25"><\/script>');
    ...
    document.write('<script src="./lunea-reading-action-order-v33.js?v=87b5a4433f25"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-thai-tarot-bridge-v32.js?v=87b5a4433f25',
    './lunea-thai-range-v33.js?v=87b5a4433f25',
    './lunea-final-prompt-priority-v1.js?v=87b5a4433f25',
    ...
    './lunea-cardback-restore-v19.js?v=87b5a4433f25',
    './lunea-universal-ai-opal-v20.js?v=2002',
    './lunea-intimacy-v34.js?v=87b5a4433f25',
    './lunea-intimacy-ai-bridge-v34.js?v=87b5a4433f25',
    './lunea-intimacy-legacy-v35.js?v=87b5a4433f25',
    './lunea-intimacy-readability-v36.js?v=87b5a4433f25',
    ...
    './lunea-reading-action-order-v33.js?v=87b5a4433f25',
