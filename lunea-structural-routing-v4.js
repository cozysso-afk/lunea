...
/* Loader shim: Structural V4 + Manual Spread + reusable library + last-reading recovery + whole-reading flip fix + question casebook + AI question preflight/preview + extended Transit range + resumable long Transit runner + Astro calculation queue + iOS sheet scroll fix + all-category manual entry + Horary multi-target guard + A/B Timing Oracle. */
(() => {
