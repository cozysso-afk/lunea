...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-reading-boundary-reset-v31.js?v=3101"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-reading-boundary-reset-v31.js?v=3101',
