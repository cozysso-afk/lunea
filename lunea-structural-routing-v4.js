...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-reading-draft-v1.js?v=b20ce07c8f9f"><\/script>');
    ...
    document.write('<script src="./lunea-transit-range-v1.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-transit-long-run-v1.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-astro-job-queue-v1.js?v=b20ce07c8f9f"><\/script>');
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=b20ce07c8f9f"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-intimacy-ai-bridge-v34.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-intimacy-legacy-v35.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-intimacy-readability-v36.js?v=b20ce07c8f9f"><\/script>');
    ...
    document.write('<script src="./lunea-astro-resume-v23.js?v=b20ce07c8f9f"><\/script>');
    ...
    document.write('<script src="./lunea-fixed-spread-depth-v30.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-general-order-v30-5.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-reading-boundary-reset-v31.js?v=3102"><\/script>');
    document.write('<script src="./lunea-reading-action-order-v33.js?v=b20ce07c8f9f"><\/script>');
    document.write('<script src="./lunea-boot-reveal-v29.js?v=b20ce07c8f9f"><\/script>');
    return;
  }
  ...
  loadSequential([
    ...
    './lunea-reading-draft-v1.js?v=b20ce07c8f9f',
    ...
    './lunea-transit-range-v1.js?v=b20ce07c8f9f',
    './lunea-transit-long-run-v1.js?v=b20ce07c8f9f',
    './lunea-astro-job-queue-v1.js?v=b20ce07c8f9f',
    ...
    './lunea-thai-tarot-bridge-v32.js?v=b20ce07c8f9f',
    './lunea-thai-range-v33.js?v=b20ce07c8f9f',
    './lunea-final-prompt-priority-v1.js?v=b20ce07c8f9f',
    ...
    './lunea-cardback-restore-v19.js?v=b20ce07c8f9f',
    './lunea-universal-ai-opal-v20.js?v=b20ce07c8f9f',
    './lunea-intimacy-v34.js?v=b20ce07c8f9f',
    './lunea-intimacy-ai-bridge-v34.js?v=b20ce07c8f9f',
    './lunea-intimacy-legacy-v35.js?v=b20ce07c8f9f',
    './lunea-intimacy-readability-v36.js?v=b20ce07c8f9f',
    './lunea-learning-success-gate-v1.js?v=101',
    './lunea-daily-orbit6-v21.js?v=2102',
    './lunea-daily-celestial-v22.js?v=2201',
    './lunea-astro-resume-v23.js?v=b20ce07c8f9f',
    ...
    './lunea-fixed-spread-depth-v30.js?v=b20ce07c8f9f',
    './lunea-general-order-v30-5.js?v=b20ce07c8f9f',
    './lunea-reading-boundary-reset-v31.js?v=3102',
    './lunea-reading-action-order-v33.js?v=b20ce07c8f9f',
    './lunea-boot-reveal-v29.js?v=b20ce07c8f9f'
