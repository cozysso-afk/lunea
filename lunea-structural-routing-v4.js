...
/* Loader shim: Structural V4 + Manual Spread + reusable library + last-reading recovery + extended Transit range + safe long Transit runner + iOS sheet scroll fix + all-category manual entry + Horary multi-target guard + A/B Timing Oracle. */
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-transit-long-run-v1.js?v=101"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-transit-long-run-v1.js?v=101',
