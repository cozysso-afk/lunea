...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-reading-draft-v1.js?v=7e913d6235da"><\/script>');
    ...
    document.write('<script src="./lunea-transit-range-v1.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-transit-long-run-v1.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-astro-job-queue-v1.js?v=7e913d6235da"><\/script>');
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=7e913d6235da"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-intimacy-ai-bridge-v34.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-intimacy-legacy-v35.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-intimacy-readability-v36.js?v=7e913d6235da"><\/script>');
    ...
    document.write('<script src="./lunea-astro-resume-v23.js?v=7e913d6235da"><\/script>');
    ...
    document.write('<script src="./lunea-fixed-spread-depth-v30.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-general-order-v30-5.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-reading-boundary-reset-v31.js?v=3102"><\/script>');
    document.write('<script src="./lunea-reading-action-order-v33.js?v=7e913d6235da"><\/script>');
    document.write('<script src="./lunea-boot-reveal-v29.js?v=7e913d6235da"><\/script>');
    return;
  }
  ...
  loadSequential([
    ...
    './lunea-reading-draft-v1.js?v=7e913d6235da',
    ...
    './lunea-transit-range-v1.js?v=7e913d6235da',
    './lunea-transit-long-run-v1.js?v=7e913d6235da',
    './lunea-astro-job-queue-v1.js?v=7e913d6235da',
    ...
    './lunea-thai-tarot-bridge-v32.js?v=7e913d6235da',
    './lunea-thai-range-v33.js?v=7e913d6235da',
    './lunea-final-prompt-priority-v1.js?v=7e913d6235da',
    ...
    './lunea-cardback-restore-v19.js?v=7e913d6235da',
    './lunea-universal-ai-opal-v20.js?v=7e913d6235da',
    './lunea-intimacy-v34.js?v=7e913d6235da',
    './lunea-intimacy-ai-bridge-v34.js?v=7e913d6235da',
    './lunea-intimacy-legacy-v35.js?v=7e913d6235da',
    './lunea-intimacy-readability-v36.js?v=7e913d6235da',
    './lunea-learning-success-gate-v1.js?v=101',
    './lunea-daily-orbit6-v21.js?v=2102',
    './lunea-daily-celestial-v22.js?v=2201',
    './lunea-astro-resume-v23.js?v=7e913d6235da',
    ...
    './lunea-fixed-spread-depth-v30.js?v=7e913d6235da',
    './lunea-general-order-v30-5.js?v=7e913d6235da',
    './lunea-reading-boundary-reset-v31.js?v=3102',
    './lunea-reading-action-order-v33.js?v=7e913d6235da',
    './lunea-boot-reveal-v29.js?v=7e913d6235da'
