...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=b6d6dbf9d7fb"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=b6d6dbf9d7fb"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=b6d6dbf9d7fb"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=b6d6dbf9d7fb"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=2003"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=b6d6dbf9d7fb"><\/script>');
    document.write('<script src="./lunea-intimacy-ai-bridge-v34.js?v=b6d6dbf9d7fb"><\/script>');
    document.write('<script src="./lunea-intimacy-legacy-v35.js?v=b6d6dbf9d7fb"><\/script>');
    document.write('<script src="./lunea-intimacy-readability-v36.js?v=b6d6dbf9d7fb"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-thai-tarot-bridge-v32.js?v=b6d6dbf9d7fb',
    './lunea-thai-range-v33.js?v=b6d6dbf9d7fb',
    './lunea-final-prompt-priority-v1.js?v=b6d6dbf9d7fb',
    ...
    './lunea-cardback-restore-v19.js?v=b6d6dbf9d7fb',
    './lunea-universal-ai-opal-v20.js?v=2003',
    './lunea-intimacy-v34.js?v=b6d6dbf9d7fb',
    './lunea-intimacy-ai-bridge-v34.js?v=b6d6dbf9d7fb',
    './lunea-intimacy-legacy-v35.js?v=b6d6dbf9d7fb',
    './lunea-intimacy-readability-v36.js?v=b6d6dbf9d7fb',
