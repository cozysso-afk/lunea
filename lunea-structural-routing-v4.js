...
(() => {
  ...
  if (document.readyState === 'loading') {
    ...
    document.write('<script src="./lunea-thai-tarot-bridge-v32.js?v=b08bae1d4a0d"><\/script>');
    document.write('<script src="./lunea-thai-range-v33.js?v=b08bae1d4a0d"><\/script>');
    document.write('<script src="./lunea-final-prompt-priority-v1.js?v=b08bae1d4a0d"><\/script>');
    ...
    document.write('<script src="./lunea-cardback-restore-v19.js?v=b08bae1d4a0d"><\/script>');
    document.write('<script src="./lunea-universal-ai-opal-v20.js?v=2002"><\/script>');
    document.write('<script src="./lunea-intimacy-v34.js?v=b08bae1d4a0d"><\/script>');
    document.write('<script src="./lunea-intimacy-ai-bridge-v34.js?v=b08bae1d4a0d"><\/script>');
    document.write('<script src="./lunea-intimacy-legacy-v35.js?v=b08bae1d4a0d"><\/script>');
    document.write('<script src="./lunea-intimacy-readability-v36.js?v=b08bae1d4a0d"><\/script>');
    ...
    document.write('<script src="./lunea-reading-action-order-v33.js?v=b08bae1d4a0d"><\/script>');
  ...
  loadSequential([
    ...
    './lunea-thai-tarot-bridge-v32.js?v=b08bae1d4a0d',
    './lunea-thai-range-v33.js?v=b08bae1d4a0d',
    './lunea-final-prompt-priority-v1.js?v=b08bae1d4a0d',
    ...
    './lunea-cardback-restore-v19.js?v=b08bae1d4a0d',
    './lunea-universal-ai-opal-v20.js?v=2002',
    './lunea-intimacy-v34.js?v=b08bae1d4a0d',
    './lunea-intimacy-ai-bridge-v34.js?v=b08bae1d4a0d',
    './lunea-intimacy-legacy-v35.js?v=b08bae1d4a0d',
    './lunea-intimacy-readability-v36.js?v=b08bae1d4a0d',
    ...
    './lunea-reading-action-order-v33.js?v=b08bae1d4a0d',
